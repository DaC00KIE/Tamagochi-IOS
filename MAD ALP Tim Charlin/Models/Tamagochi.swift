...
class Tamagochi: ObservableObject{
    ...
    func eat(amount: Int) {
        let effectiveAmount = amount + hunger.actionEffect
        hunger.add(effectiveAmount)
    }
    
    func clean(amount: Int) {
        let effectiveAmount = amount + cleanliness.actionEffect
        cleanliness.add(effectiveAmount)
    ...
    func play(amount: Int) {
        let effectiveAmount = amount + fun.actionEffect
        fun.add(effectiveAmount)
